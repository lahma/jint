...
{
    public class ArrayBufferPrototype : ArrayBufferInstance
    {
        ...
        protected override void Initialize()
        {
            var properties = new PropertyDictionary(2, checkExistingKeys: false)
            {
                ...
                ["slice"] = new PropertyDescriptor(new ClrFunctionInstance(Engine, "slice", Slice, 2, PropertyFlag.Configurable), PropertyFlag.Configurable)
            };
        ...
        private JsValue ByteLength(JsValue thisObj, JsValue[] arguments)
        {
            ...
            return JsNumber.Create(o._arrayBufferByteLength);
        }
        ...
        private JsValue Slice(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var len = O._arrayBufferByteLength;
            ...
            if (bufferInstance._arrayBufferByteLength < newLen)
            {
                ExceptionHelper.ThrowTypeError(_realm);
            }
            ...
            var fromBuf = O._arrayBufferData;
            var toBuf = bufferInstance._arrayBufferData;
